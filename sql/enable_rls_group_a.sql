...
-- 1. 移動支援（move）系
-- -------------------------------------------------------------
ALTER TABLE public.schedule_tasks_move       ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_notes_move        ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.move_check_logs           ENABLE ROW LEVEL SECURITY;

-- -------------------------------------------------------------
-- 2. 居宅介護（home）系
-- -------------------------------------------------------------
ALTER TABLE public.home_schedule_tasks       ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_notes_home        ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_action_logs_home  ENABLE ROW LEVEL SECURITY;

-- -------------------------------------------------------------
-- 3. 構造化記録系
-- -------------------------------------------------------------
ALTER TABLE public.service_record_structured ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_action_logs       ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_irregular_events  ENABLE ROW LEVEL SECURITY;
...
-- 5. 落ち着き確認系
-- -------------------------------------------------------------
ALTER TABLE public.calm_checks               ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.calm_check_targets        ENABLE ROW LEVEL SECURITY;
...
-- =============================================================
-- ALTER TABLE public.schedule_tasks_move       DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_notes_move        DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.move_check_logs           DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.home_schedule_tasks       DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_notes_home        DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_action_logs_home  DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_record_structured DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_action_logs       DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.service_irregular_events  DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.training_reports          DISABLE ROW LEVEL SECURITY;
...
-- ALTER TABLE public.contract_parties          DISABLE ROW LEVEL SECURITY;
...
-- ALTER TABLE public.admin_error_alerts        DISABLE ROW LEVEL SECURITY;
