...
exports.handleBonusLeaderboard = handleBonusLeaderboard;
...
async function handleBonusLeaderboard(req, res) {
    ...
    try {
        ...
        const items = rows.map((r) => {
            ...
            const kigenRate = r.yotei > 0 ? Math.round((1000 * r.kigennai) / r.yotei) / 10 : 0;
