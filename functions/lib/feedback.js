...
exports.handleGetFeedback = handleGetFeedback;
exports.handleUpdateFeedbackStatus = handleUpdateFeedbackStatus;
exports.handleGetResolvedFeedback = handleGetResolvedFeedback;
 ...
 */
async function transformWithAI(originalMessage) {
 ...
 */
async function transformReplyWithAI(originalReply) {
    const openai = (0, openai_1.getOpenAIClient)();
 ...
 */
async function handleUpdateFeedbackStatus(req, res) {
    try {
 ...
 */
async function handleGetResolvedFeedback(_req, res) {
    try {
        const supabase = (0, supabase_1.getSupabaseClient)();
