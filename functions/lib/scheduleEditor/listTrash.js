...
exports.handleScheduleEditorListTrash = handleScheduleEditorListTrash;
 ...
 */
async function handleScheduleEditorListTrash(req, res) {
    try {
        ...
        const days = Number.isInteger(daysParam) && daysParam > 0 && daysParam <= 365
            ? daysParam
            : 90;
        ...
        const { data, error } = await supabase
            .from("schedule")
            .select("id, date, name, client, start_time, end_time, haisha, task, summary, deleted_at, updated_at")
